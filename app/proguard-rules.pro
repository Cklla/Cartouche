...
# renvoyé par RAWG/IGDB/Twitch, donc ni renommage ni suppression.
-keep class fr.cklla.cartouche.data.remote.dto.** { *; }
-keep class fr.cklla.cartouche.data.remote.igdb.dto.** { *; }
