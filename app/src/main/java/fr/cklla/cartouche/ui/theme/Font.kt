...
// Fraunces et Inter sont distribuées ici sous forme de polices variables (un seul
// fichier .ttf couvrant plusieurs graisses) : on règle l'axe "wght" via
// FontVariation.Settings plutôt que d'embarquer un fichier par graisse.
// Sous Android < 26, l'axe est ignoré et la police s'affiche dans sa graisse par
// défaut — dégradation acceptable, l'italique reste correct.
